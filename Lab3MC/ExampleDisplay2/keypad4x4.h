...
bool isButtonPressed() {
  ...
  { //якщо =1, тоді ще не натискалася
    if (PIN_KEYPAD != 0xF0)
    {
      ...
      {
        switch (PIN_KEYPAD) {
          case (Key_1): pressedButton = '1';
          break;
          case (Key_2): pressedButton = '2';
          break;
          case (Key_3): pressedButton = '3';
          break;
          case (Key_4): pressedButton = '4';
          break;
          case (Key_5): pressedButton = '5';
          break;
          case (Key_6): pressedButton = '6';
          break;
          case (Key_7): pressedButton = '7';
          break;
          case (Key_8): pressedButton = '8';
          break;
          case (Key_9): pressedButton = '9';
          break;
          case (Key_0): pressedButton = '0';
          break;
          case (Key_A): pressedButton = 'A';
          break;
          case (Key_B): pressedButton = 'B';
          break;
          case (Key_C): pressedButton = 'C';
          break;
          case (Key_D): pressedButton = 'D';
          break;
          case (Key_E): pressedButton = 'E';
          break;
          case (Key_F): pressedButton = 'F';
          break;
        }
